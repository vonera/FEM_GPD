...
for j = 2:18
    % norm precipitatio
    accum_precip{j-1} = accum_precip{j-1}./median(accum_precip{j-1}(accum_precip{j-1}>0));
...
save(['daily_accumulated_norm_precipitation_',num2str(QL),'_delayedENSO_diffnorm.mat'], 'daily_accumulated_precipitation');
