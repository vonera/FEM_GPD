...
classdef Factory
    ...
    methods(Static)
        ...
        function cfg = createGammaCfg(cgam)
            ...
            if strcmp(cgam.type, 'ADAPTIVE')
                cfg = Core.Construction.GammaAConfig(cgam.type,...
                                                          cgam.annealing,...
                                                          cgam.diagnostics);
                
            elseif strcmp(cgam.type, 'LINEAR')     ||...
                   strcmp(cgam.type, 'LINEARjas')  
               cfg = Core.Construction.GammaLConfig(cgam.type,...
                   cgam.num_fe,...
                   cgam.discrete,...
                   cgam.diagnostics);
               
            elseif strcmp(cgam.type, 'SPATIAL_H1')     ||...
                    strcmp(cgam.type, 'SPATIAL_BV_Mat') ||...
                    strcmp(cgam.type, 'SPATIAL_BV_Gurobi')||...
                    strcmp(cgam.type, 'parforSPATIAL_BV_Gurobi')||...
                    strcmp(cgam.type, 'parforSPATIAL_ADAPTIVE')
                ...
                error(['unknown gamma.type ' cgam.type ...
                    ' expected {ADAPTIVE, LINEAR, LINEARjas, SPATIAL_H1, ',...
                    'SPATIAL_BV_Mat, SPATIAL_BV_Gurobi, parforSPATIAL_BV_Gurobi,parforSPATIAL_ADAPTIVE']);
            end
        end
